...
<body>
  ...
  <div class="wrap">
    <header class="topbar">
      <div class="container">
        <div class="nav">
          ...
          <button id="openSidebar" class="sidebar-toggle btn primary">
          <i class="fa-solid fa-bars"></i>
        </button>
        <!-- Sidebar -->
        <aside id="sidebar" class="sidebar">
          <div class="asid_logo_wraper">
                <div class="brand">
            <a class="logo" href="/" aria-label="Ezead Home">
              <img src="https://eze.pics/ezead-chat-images/logo2.png" alt="Ezead Logo" onerror="this.style.display='none'; this.parentElement.innerHTML='&lt;span style=&quot;font-weight:900;color:rgba(24,247,255,.95)&quot;&gt;E&lt;/span&gt;';">
            </a>
          </div>
            <button id="closeSidebar" class="sidebar-toggle btn primary">
                <i class="fa-solid fa-xmark"></i>
            </button>
          </div>
        
            <nav class="navlinks" aria-label="Sidebar Navigation">
                <a class="chip primary" href="#get-started">
                    <span class="dot"></span>Get Started
                </a>
        
                <a class="chip" href="#features">
                    <span class="dot"></span>Features
                </a>
        
                <a class="chip purple" href="#pricing">
                    <span class="dot"></span>Pricing
                </a>
        
                <a class="chip" href="company/login" title="Company Portal">
                    <span class="dot"></span>Company Login
                </a>
        
                <a class="chip" href="/admin/login" title="Admin Console">
                    <span class="dot"></span>Admin Login
                </a>
        
                <a class="chip purple" href="/agent/login" title="Agent Desk">
                    <span class="dot"></span>Agent Login
                </a>
            </nav>
        </aside>
        </div>
    ...
    <footer>
      ©2003- ©<span id="year"></span> Ezead Media Group — Powered by Ezead AI
    </footer>
  </div>
